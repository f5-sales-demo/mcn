...
sessions. [AWS acceptance](https://github.com/f5-sales-demo/mcn/pull/1103) verified a single
...
1. **Dynamic BGP / ECMP Routing (Azure Route Server / AWS Transit Gateway Connect / FRR ToR)**: Used for the Rest of World (`eastus`), AWS (`ap-northeast-1`), and On-Premise KVM paths.
