...
1. **Versions & Providers** (`versions.tf`, `providers.tf`):
   ...
   - Providers: `f5-sales-demo/xcsh` (`= 9.0.0`, setting `api_url = local.xc_api_url` derived from
...
| --- | --- |
| `f5-sales-demo/xcsh = 9.0.0` | Provides the immutable SMSv2 contract and pre-mutation Azure Route Server multihop capability gate. |
