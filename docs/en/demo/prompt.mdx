...
1. **Versions & Providers** (`versions.tf`, `providers.tf`):
   ...
   - Providers: `f5-sales-demo/xcsh` (`= 9.0.1`, setting `api_url = local.xc_api_url` derived from
...
| --- | --- |
| `f5-sales-demo/xcsh = 9.0.1` | Provides the immutable SMSv2 contract, Azure NIC MAC-read stability, and the pre-mutation Azure Route Server multihop capability gate. |
