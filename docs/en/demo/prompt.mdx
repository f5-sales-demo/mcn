...
1. **Versions & Providers** (`versions.tf`, `providers.tf`):
   ...
   - Providers: `f5-sales-demo/xcsh` (`= 7.3.0`, setting `api_url = local.xc_api_url` derived from
...
| --- | --- |
| `f5-sales-demo/xcsh = 7.3.0` | Provides the clean-break SMSv2 contract, MAC-bound runtime health, and BGP convergence data sources. |
