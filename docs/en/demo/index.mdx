...
<CardGrid>
  ...
  <LinkCard
    ...
    description="The zero-memory engineered prompt that reproduces the complete modular Terraform codebase directly via xcsh -p."
    href="./prompt/"
  />
  <LinkCard
    title="Engineering Spec"
    description="Human-readable, minimal engineering specification derived from the source-of-truth prompt."
    href="./spec/"
  />
</CardGrid>
