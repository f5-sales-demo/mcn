...
Azure CEs exchange host routes with Azure Route Server. The AWS path uses Transit Gateway
...
Evidence is platform- and date-scoped. [AWS v8 acceptance](https://github.com/f5-sales-demo/mcn/pull/1103)
...
| Advertised VIPs | `var.vip` (`10.250.0.10`) for ROW; `var.ca_vip` (`10.250.1.10`) for Canada; internal AWS NLB `var.aws_vip` (`10.151.1.10`) fronts three BGP-routed SMSv2 site listeners; `10.100.0.10` for On-Prem KVM |
