...
addresses are not in node order. Observed 2026-07-28 the three CEs held `10.0.3.7`,
`10.0.3.5` and `10.0.3.4` — not sequential, and different from what they held before that
rebuild.
...
now be the client's — on this deployment it holds `10.0.3.6`, which a CE held before an
earlier rebuild.
