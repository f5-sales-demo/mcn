---
title: The Terraform
description: The configuration that deploys this demo, read from the files that deploy it rather than retyped — the root module and its six child modules, with a note on what each file is responsible for.
sidebar:
  order: 20
  label: Terraform
---
