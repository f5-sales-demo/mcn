...
require_text terraform/versions.tf 'version = "= 9.3.0"'
...
require_text terraform/aws/aws_xc.tf 'public_name { dns_name = var.aws_origin_dns_name }'
reject_text terraform/aws/aws_vpc.tf 'resource "aws_instance" "origin"'
reject_text terraform/aws/aws_vpc.tf 'resource "aws_security_group" "origin"'
reject_text terraform/aws/aws_xc.tf 'aws_instance.origin[0].public_ip'
