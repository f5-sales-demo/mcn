...
require_text terraform/aws_xc.tf 'no_v6_static_routes = {}'
require_text terraform/aws_xc.tf 'vip_vrrp_mode = "VIP_VRRP_ENABLE"'
require_text terraform/aws_tgw_connect.tf 'resource "xcsh_bgp_routing_policy" "aws_vip_export" {'
require_text terraform/aws_tgw_connect.tf 'ip_prefixes = "${var.aws_vip}/32"'
require_text terraform/aws_tgw_connect.tf 'exact_match = {}'
require_text terraform/aws_tgw_connect.tf 'allow = {}'
require_text terraform/aws_tgw_connect.tf 'routing_policies {'
require_text terraform/aws_tgw_connect.tf 'outbound  = {}'
require_text terraform/aws_tgw_connect.tf 'all_nodes = {}'
require_text terraform/aws_tgw_connect.tf 'name      = xcsh_bgp_routing_policy.aws_vip_export[0].name'
